        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
            ...
            <div>
               ...
               <button class="btn btn-primary" style="color: white;" data-toggle="modal" data-target="#modalForm"><i class="fa fa-plus-circle"></i> Add Photo</button>    
...
<?php
	...
	if (isset($_POST['tambah'])) {
        ...
        $tangkapFile		= $_POST['file'];
		$tangkapKetP		= $_POST['fileDesc'];
        
        // UPLOAD FOTO START
        $target_dir = "../fiyeo/img/";
		...
		$query = mysqli_query($koneksi , "insert into portfolio values ('', '$tangkapFile', '$tangkapKetP')");
	}
...
?>
			<tr> 
			 <td><img src="../fiyeo/img/<?php echo $photo ?>" width ='100px' height='100px'></td>
