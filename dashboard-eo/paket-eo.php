        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
            ...
            <div>
               ...
               <button class="btn btn-primary" style="color: white;" data-toggle="modal" data-target="#modalForm"><i class="fa fa-plus-circle"></i> Add Service Package</button>
 ...
 <?php
	...
	?>
			...
			<td colspan='2'> 
                ...
                <input type="button" class="btn btn-default btn-sm edit_data" value="Edit" name="edit" id="paket" />
                                             
                <a onclick="delRecord(4947)" class="btn btn-default btn-sm">Delete</a></div>
    ...
    <script type="text/javascript">
     ...
     <script>
        var notice = false;
        $('li a#notice').tooltip({placement: 'bottom'}).tooltip('show');
// $('li a#notice').onclick(function() { if (!notice) { $('li a#notice').tooltip({placement: 'bottom'}).tooltip('show'); } });
$('li a#notice').click(function() { notice = true; $(this).tooltip('destroy'); });
</script>
    <script type="text/javascript">
	$(document).ready(function() {
