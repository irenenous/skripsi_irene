...
<style>
  ...
  <body>
   <div class="page" style="background-color: white;">
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Facility & Service Criteria (C3)</h2>
            </div>
          </header>
    ...
    <input type="text" class="form-control" name="fasilitasid" id="fasilitasid" value="<?php echo $idfasilitas ?>" disabled>   
    </div>          
    <div class="form-group">
