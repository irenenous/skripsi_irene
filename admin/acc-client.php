                            ...
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td>Irene Andriani</td><td>irenenous@yahoo.com</td>
                                        <td>081250381345</td>
                                        <td>andriani123</td>
                                       ...
                                       <tr>
                                        ...
                                        <td>Helen Tandra</td><td>helen@yahoo.com</td>
                                        <td>081250323538</td>
                                        <td>123456</td>
                                        <td><span class="badge badge-complete" style="background-color: red; color: white;">Pending</span>
                                        </td>
                                        <td>  
                                        <button type="button" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> 
                                        <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></td>
