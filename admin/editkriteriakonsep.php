...
<style>
  ...
  <body>
   <div class="page" style="background-color: white;">
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Concept & Decoration Criteria (C4)</h2>
            </div>
          </header>
    ...
    <?php
	include("config.php");
    if(!empty($_GET['id_kriteria_konsep'])){
	$idkonsep = $_GET['id_kriteria_konsep']; }

    $query1="SELECT * FROM kriteria_konsep INNER JOIN indikator_penilaian ON kriteria_konsep.id_indikator_penilaian = indikator_penilaian.id_indikator_penilaian where id_kriteria_konsep = '".$idkonsep."'";
    ...
    <form method="POST" action="updatekriteriakonsep.php?id_kriteria_konsep=<?php echo $idkonsep ?>" class="form-horizontal">            
    <div class="form-group">
    <label for="id">ID </label>
    <input type="text" class="form-control" name="konsepid" id="konsepid" value="<?php echo $idkonsep ?>" disabled>   
    </div>          
    <div class="form-group">
    <label for="name">Criteria Detail </label>
    <input type="text" class="form-control" name="detailkonsep" id="detailkonsep" value="<?php echo $detailkriteria ?>" required> 
    </div>
    <div class="form-group">
